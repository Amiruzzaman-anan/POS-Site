...
<?php
    ...
    $pname = mysqli_real_escape_string($conn, htmlentities($_GET['pname']));
    //$pname = htmlentities($_GET['pname']);
    $qty = $_GET['qty'];
    ...
    <div class="container-fluid mt-3">
        <form class="row g-3 container-fluid" method="post" action="edit2.php">
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control bg-danger text-white fw-bold" name="pname" readonly="readonly" value="<?php echo $pname; ?> "> 
                </div>
            <div class="col-sm-3">
                <label for="inputEmail4" class="form-label">Previous Quantity</label>
                <input type="text" class="form-control"  readonly="readonly" id="prv_qty" name="qty" value="<?php echo $qty; ?>">
            </div>
            <div class="col-sm-3">
                <label for="inputEmail4" class="form-label">Available Quantity</label>
            ...
            <div class="col-sm-3">
                <label for="inputEmail4" class="form-label">Updated Quantity</label>
