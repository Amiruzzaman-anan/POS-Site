...
<?php
    ...
    $data = $_GET['companygiven'];
    $data2 = $_GET['namegiven1'];
    // echo $data2;
    var_dump($data2);
    var_dump($data);
    $sql = "SELECT * FROM `product` WHERE `company` = '$data' OR `product_name` = '$data2';";
    $result = mysqli_query($conn, $sql) or die("cannot execute query in company");
