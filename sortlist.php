          ...
          <tbody>
            ...
            <tr class="bg-light">
                    ...
                    <td  align="center">
                          ...
                          <input type="text" class="form-control  fw-bold text-danger" readonly="readonly" name="edit_order_xurrentttk"  id="ordercurrenttk" value="<?php echo $ordertk; ?>" required>
                    ...
                    <td colspan="4" align="center">
                          ...
                          <input type="text" class="form-control  fw-bold text-danger" readonly="readonly" name="edit_order_discounttk"  id="orderdiscounttk" placeholder="<?php echo $totaltk; ?>" required>
